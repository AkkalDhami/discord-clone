...
export function ServerSection({ server, role, memberId }: ServerSectionProps) {
  ...
  return (
    <ContextMenu>
      <ContextMenuTrigger className={"w-full space-y-4 px-3 py-1"}>
...
function ChannelCard({
  ...
  return (
    <Link
      ...
      className={cn(
        "hover:bg-secondary group/channel mt-2 flex w-full cursor-pointer items-center justify-between space-x-4 rounded-md px-2 py-1.5",
